...
const panierList = panier.map((article,i) => {
  return (
...
<View style={{width:'90%',marginBottom:10, height:40,justifyContent:'space-between',alignItems:'center', display:'flex',flexDirection:'row', borderWidth:3,borderColor:'black',borderRadius:10,height:80}}>

        <Text style={{marginLeft:40, width:'30%'}}>TOTAL :</Text>
        <Text >25,8 € </Text>
        <TouchableOpacity
